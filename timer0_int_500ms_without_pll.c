// Assume PCLK = CCLK = 60MHz
// Steps to setup PCLK = CCLK in PLL
/*Click Starup.s->Select Configuration Wizard (Tab)
Put Tick Mark in VPB Setup
Select VPB Clock as "VPB Clock = CPU Clock"
Put Tick Mark in PLL Setup
